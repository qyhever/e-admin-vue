  ...
  watch: {
    value(newValue) {
      if (!this.inited) {
        ...
        this.fileList = newValue.map((url, index) => ({ name: String(index), url }))
      }
    }
  },
  methods: {
    ...
    handlePictureCardPreview(file) {
      if (this.preview) {
        ...
        this.$refs.viewer.preview(urls, index)
      }
    },
...
<style lang="scss" scoped>
  .upload-container /deep/ .el-upload-list--picture-card .el-upload-list__item-thumbnail {
    object-fit: cover;
  }
</style>
